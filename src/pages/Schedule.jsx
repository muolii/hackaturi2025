  ...
  const scheduleData = {
    day1: {
      ...
      events: [
        ...
        { time: '3:30 PM', event: 'Git: The Hard Way', location: 'ENGR 010C', type: 'workshop' },
        { time: '4:00 PM', event: 'Hacking Interfaces and Human Perception', location: 'ENGR 045C', type: 'cyber' },
