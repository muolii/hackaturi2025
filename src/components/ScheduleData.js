...
export const SCHEDULE = {
  day1: {
    ...
    events: [
      ...
      { time: '11:15 AM', duration: 90,  event: 'Mentor Office Hours (Round 1)',     location: 'Mentor Lounge',                       type: 'mentoring' },
      ...
      { time: '2:30 PM',  duration: 90,  event: 'Mentor Office Hours (Round 2)',     location: 'Mentor Lounge',                       type: 'mentoring' },
  ...
  day2: {
    ...
    events: [
      ...
      { time: '12:00 PM', duration: 60,  event: 'LUNCH',                             location: 'Fascitelli Commons',                  type: 'food' },
      { time: '12:15 PM', duration: 60,  event: 'Pitch Practice & Feedback',         location: 'Mentor Lounge',                       type: 'mentoring' },
