...
export const SCHEDULE = {
  ...
  day2: {
    ...
    events: [
      ...
      { time: '9:00 AM', duration: 0,   event: 'FINAL SUBMISSIONS DUE',             location: 'DevPost (Online)',                     type: 'hacking', hero: true },
      { time: '9:00 AM', duration: 45,  event: 'Pitching Workshop: How to Tell Your Story & Demo Effectively', location: 'ENGR 025C', type: 'beginner' },
      { time: '10:00 AM',  duration: 90, event: 'Project Expo & Judging Begins',     location: 'Expo Area',                           type: 'hacking', hero: true },
      { time: '11:30 AM', duration: 60,  event: 'LUNCH',                             location: 'Fascitelli Commons',                  type: 'food' },
      { time: '12:00 PM',  duration: 60, event: 'Finalist Round | Pitching',          location: 'Pharmacy 170',                        type: 'hacking' },
      { time: '2:00 PM',  duration: 30,  event: 'Closing Ceremony & Awards',         location: 'Common/Stage',                        type: 'ceremony' },
    ],
  },
};
